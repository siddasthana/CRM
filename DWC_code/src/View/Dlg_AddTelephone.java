...
public class Dlg_AddTelephone extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dlg_AddTelephone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dlg_AddTelephone dialog = new Dlg_AddTelephone(new javax.swing.JFrame(), true);
